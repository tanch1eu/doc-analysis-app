# PART II
# Question 4, Model implementation using <desc> as Query, while includes features selection for ranking documents.
...
if __name__ == "__main__":
    ...
    # IF model implementation with features selection
    os.chdir('..')
    benFile = open('NewTraining_benchmark101.txt')
    ...
    wFile = open('Model_w4_R101.dat', 'w')
