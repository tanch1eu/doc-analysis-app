# PART I
# Question 3, Baseline model implementation using <title> as Query, assumming that R = 0, r_k = 0;
...
if __name__ == "__main__":
    ...
    # Baseline model implementation, using only <title> as Query
    df_ = df.calc_df(coll_)
    bm25_1 = bm25(coll_, "Economic espionage", df_)
    print('Done.')
    os.chdir('..')
    wFile = open('B_Result1.dat', 'w')
